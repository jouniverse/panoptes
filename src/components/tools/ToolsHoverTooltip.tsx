...
export function ToolsHoverTooltip() {
  const hovered = useStore((s) => s.toolsHovered);
  const screen = useStore((s) => s.toolsHoverScreen);
  ...
  return (
    ...
    >
      <div
        className="pan-glass pan-notch-tr border-l-2 px-2 py-1.5"
        style={{ borderLeftColor: layer?.color }}
      >
        <div className="flex items-center gap-1.5">
          <span className="inline-block h-2 w-2" style={{ background: layer?.color }} />
