...
export const LAYERS: LayerDefinition[] = [
  ...
  },
  {
    ...
    renderer: "both",
    defaultEnabled: false,
    description: "Live military ADS-B aircraft (adsb.lol + OpenSky military hex filter). Enriched with operator country when identifiable.",
    source: {
      kind: "api",
      ref: "flights",
      attribution: "adsb.lol / OpenSky",
      license: "ODbL",
      cadence: "60s",
    },
  },
