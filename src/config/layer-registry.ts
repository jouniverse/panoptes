...
export const LAYERS: LayerDefinition[] = [
  ...
  // ----------------------------------------------------------------- maritime
  {
    ...
    placeholder: true,
    description:
      "Live AIS vessel positions (deferred). Requires WebSocket relay + military/tanker filtering. Placeholder only.",
    source: {
      kind: "static",
      ref: "maritime-ais.geojson",
      attribution: "AISStream (deferred)",
      cadence: "static",
    },
  },
  {
  ...
  },
  {
    ...
    kind: "point",
    marker: "hexagon",
    color: PALETTE.friendly, // green — distinct from Launch & Spaceports (pale-cyan hexagon)
    renderer: "both",
    defaultEnabled: false,
    description:
  ...
  // --------------------------------------------------------- plants & factories
  {
    ...
    renderer: "both",
    defaultEnabled: false,
    description: "Global power plants ≥ 100 MW (WRI Global Power Plant Database). Markers color-coded by fuel type.",
    source: {
      kind: "static",
  ...
  // ---------------------------------------------------------------- conflict
  {
    ...
    defaultEnabled: false,
    description:
      "Militarized interstate disputes & incidents (COW MIDLOC 2.1, 1816–2014). Gold = dispute-level (MIDLOCA); red = incident-level (MIDLOCI). Overlapping locations are jittered for visibility.",
    approxLocation: true,
    source: {
      kind: "static",
